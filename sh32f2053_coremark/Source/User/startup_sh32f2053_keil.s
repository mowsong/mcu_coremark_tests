;/*****************************************************************************/
;/* startup_sh32f2xx_keil.s: Startup file for Sinowealth SH32F2 device series */
;/*****************************************************************************/
...
;// </h> 
SystemStack_Size  EQU     0x00000A00
...
__Vectors
                         ...
                         DCD      MCM2_FLT_Handler     ;  15 (07CH) MCM2 FAULT Interrupt
                         DCD      MCM2_PWM_Handler     ;  16 (080H) MCM2 PWM Interrupt
                         DCD      ADC1_Handler         ;  17 (084H) ADC1 Interrupt
                         DCD      ADC2_Handler         ;  18 (088H) ADC2 Interrupt
                         DCD      ADC3_Handler         ;  19 (08CH) ADC3 Interrupt
                         DCD      Default_Handler      ;  20 (090H) MCM3 FAULT Interrupt
                         DCD      Default_Handler      ;  21 (094H) MCM3 PWM Interrupt
...
Default_Handler          PROC
                         ...
                         EXPORT   MCM2_FLT_Handler     [WEAK]
                         EXPORT   MCM2_PWM_Handler     [WEAK]
