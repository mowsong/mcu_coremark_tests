...
#ifndef __SH32F9XX_SA0_H__
#define __SH32F9XX_SA0_H__
...
#define __MPU_PRESENT             0       /*!< SH32F9xxx provides an MPU                     */
#define __NVIC_PRIO_BITS          4       /*!< SH32F9xxx uses 4 Bits for the Priority Levels */
...
/******  SH32Fxxx specific Interrupt Numbers *******************************************************************/
  ...
  Reserve3_IRQn               = 13,     /*!< Reserved                                                          */
  Reserve4_IRQn               = 14,     /*!< Reserved                                                          */
  Reserve5_IRQn               = 15,     /*!< Reserved                                                          */
  Reserve6_IRQn               = 16,     /*!< Reserved                                                          */
  ADC1_IRQn                   = 17,     /*!< ADC1 Interrupt                                                    */
  Reserve7_IRQn               = 18,     /*!< Reserved                                                          */
  ADC2_IRQn                   = 19,     /*!< ADC2 Interrupt                                                    */
  Reserve8_IRQn               = 20,     /*!< Reserved                                                          */
  Reserve9_IRQn               = 21,     /*!< Reserved                                                          */
  ...
  Reserve10_IRQn              = 32,     /*!< Reserved                                                          */
  Reserve11_IRQn              = 33,     /*!< Reserved                                                          */
  Reserve12_IRQn              = 34,     /*!< Reserved                                                          */
  Reserve13_IRQn              = 35,     /*!< Reserved                                                          */
  TWI_IRQn                    = 36,     /*!< TWI Interrupt                                                     */
  Reserve14_IRQn              = 37,     /*!< Reserved Interrupt                                                */
  ...
  Reserve15_IRQn              = 43,     /*!< Reserved Interrupt                                                */
  EXTI15_10_IRQn              = 44,     /*!< EXTI Line10 ~ Line15 Interrupt                                    */
  Reserve16_IRQn              = 45,     /*!< Reserved Interrupt                                                */
  Reserve17_IRQn              = 46,     /*!< Reserved Interrupt                                                */
  Reserve18_IRQn              = 47,     /*!< Reserved Interrupt                                                */
  Reserve19_IRQn              = 48,     /*!< Reserved Interrupt                                                */
  TIM0_IRQn                   = 49,     /*!< TIM0 Interrupt                                                    */
  TIM1_IRQn                   = 50,     /*!< TIM1 Interrupt                                                    */
  TIM2_IRQn                   = 51,     /*!< TIM2 Interrupt                                                    */
  TIM3_IRQn                   = 52,     /*!< TIM3 Interrupt                                                    */
} IRQn_Type;
...
typedef struct
{
    ...
    union {
        ...
        struct {
            ...
            __IO  uint32_t  PLLF      : 5;  /*!< [b16~b12]*/
                  uint32_t  rev0      : 1;  /*!< [b17~b17]*/
    ...
    union {
        ...
        struct {
            ...
            __IO  uint32_t  ADC1RST   : 1;  /*!< [b3~b3]*/
                  uint32_t  rev1      : 1;  /*!< [b4~b4]*/
            __IO  uint32_t  ADC2RST   : 1;  /*!< [b5~b5]*/
            __IO  uint32_t  SYSCFGRST : 1;  /*!< [b6~b6]*/
            __IO  uint32_t  DMARST    : 1;  /*!< [b7~b7]*/
                  uint32_t  rev2      : 1;  /*!< [b8~b8]*/
            ...
            __IO  uint32_t  GPTRST    : 1;  /*!< [b14~b14]*/
                  uint32_t  rev3      :17;  /*!< [b31~b15]*/
        }BIT;
    }AHBRSTR;                               /*!< 0014H */
         uint32_t  APB2RSTR;                                /*!< 0018H */
    union {
        __IO  uint32_t  V32;                                /*!< 001CH */
        struct {
    ...
    union {
        ...
        struct {
         ...
         uint32_t  Reserved0[1];                            /*!< 0034H */
    __IO uint16_t  RCCLOCK;                                 /*!< 0038H */
         uint16_t  Reserved1;                               /*!< 003AH */
}RCC_TypeDef;
...
#define TIM0_BASE                      ((uint32_t)0x40000400)    /* Bus:APB1        Module:TIM        */
#define TIM1_BASE                      ((uint32_t)0x40000800)    /* Bus:APB1        Module:TIM        */
#define TIM2_BASE                      ((uint32_t)0x40000C00)    /* Bus:APB1        Module:TIM        */
#define TIM3_BASE                      ((uint32_t)0x40001000)    /* Bus:APB1        Module:TIM        */
...
#define ADC2_BASE                      ((uint32_t)0x40041800)    /* Bus:AHB         Module:ADC        */
...
#define FLASH_CR_SNB_Msk             (0x3FUL /*<< FLASH_CR_SNB_Pos*/)             /*!<FLASH CR: SNB Mask */
...
#define RCC_AHBRSTR_ADC2RST_Pos      5                                            /*!<RCC AHBRSTR: ADC2RST Position */
...
#define RCC_APB1RSTR_TIM0RST_Pos     0                                            /*!<RCC APB1RSTR: TIM0RST Position */
#define RCC_APB1RSTR_TIM0RST_Msk     (0x1UL /*<< RCC_APB1RSTR_TIM0RST_Pos*/)      /*!<RCC APB1RSTR: TIM0RST Mask */

#define RCC_APB1RSTR_TIM1RST_Pos     1                                            /*!<RCC APB1RSTR: TIM1RST Position */
#define RCC_APB1RSTR_TIM1RST_Msk     (0x1UL << RCC_APB1RSTR_TIM1RST_Pos)          /*!<RCC APB1RSTR: TIM1RST Mask */

#define RCC_APB1RSTR_TIM2RST_Pos     2                                            /*!<RCC APB1RSTR: TIM2RST Position */
#define RCC_APB1RSTR_TIM2RST_Msk     (0x1UL << RCC_APB1RSTR_TIM2RST_Pos)          /*!<RCC APB1RSTR: TIM2RST Mask */

#define RCC_APB1RSTR_TIM3RST_Pos     3                                            /*!<RCC APB1RSTR: TIM3RST Position */
#define RCC_APB1RSTR_TIM3RST_Msk     (0x1UL << RCC_APB1RSTR_TIM3RST_Pos)          /*!<RCC APB1RSTR: TIM3RST Mask */
...
#define RCC_APB1RSTR_Msk_ALL         (RCC_APB1RSTR_TIM0RST_Msk     |\
                                      RCC_APB1RSTR_TIM1RST_Msk     |\
...
#define RCC_AHBENR_ADC2EN_Pos        5                                            /*!<RCC AHBENR: ADC2EN Position */
...
#define RCC_APB1ENR_TIM0EN_Pos       0                                            /*!<RCC APB1ENR: TIM0EN Position */
#define RCC_APB1ENR_TIM0EN_Msk       (0x1UL /*<< RCC_APB1ENR_TIM0EN_Pos*/)        /*!<RCC APB1ENR: TIM0EN Mask */

#define RCC_APB1ENR_TIM1EN_Pos       1                                            /*!<RCC APB1ENR: TIM1EN Position */
#define RCC_APB1ENR_TIM1EN_Msk       (0x1UL << RCC_APB1ENR_TIM1EN_Pos)            /*!<RCC APB1ENR: TIM1EN Mask */

#define RCC_APB1ENR_TIM2EN_Pos       2                                            /*!<RCC APB1ENR: TIM2EN Position */
#define RCC_APB1ENR_TIM2EN_Msk       (0x1UL << RCC_APB1ENR_TIM2EN_Pos)            /*!<RCC APB1ENR: TIM2EN Mask */

#define RCC_APB1ENR_TIM3EN_Pos       3                                            /*!<RCC APB1ENR: TIM3EN Position */
#define RCC_APB1ENR_TIM3EN_Msk       (0x1UL << RCC_APB1ENR_TIM3EN_Pos)            /*!<RCC APB1ENR: TIM3EN Mask */
...
#define RCC_APB1ENR_Msk_ALL          (RCC_APB1ENR_TIM0EN_Msk       |\
                                      RCC_APB1ENR_TIM1EN_Msk       |\
...
#define RCC_AHBRSTR_ADC2RST_BIT                   (*(__IO uint32_t*)(0x42888294))
...
#define RCC_APB1RSTR_TIM0RST_BIT                  (*(__IO uint32_t*)(0x42888380))
#define RCC_APB1RSTR_TIM1RST_BIT                  (*(__IO uint32_t*)(0x42888384))
#define RCC_APB1RSTR_TIM2RST_BIT                  (*(__IO uint32_t*)(0x42888388))
#define RCC_APB1RSTR_TIM3RST_BIT                  (*(__IO uint32_t*)(0x4288838C))
...
#define RCC_AHBENR_ADC2EN_BIT                     (*(__IO uint32_t*)(0x42888414))
...
#define RCC_APB1ENR_TIM0EN_BIT                    (*(__IO uint32_t*)(0x42888500))
#define RCC_APB1ENR_TIM1EN_BIT                    (*(__IO uint32_t*)(0x42888504))
#define RCC_APB1ENR_TIM2EN_BIT                    (*(__IO uint32_t*)(0x42888508))
#define RCC_APB1ENR_TIM3EN_BIT                    (*(__IO uint32_t*)(0x4288850C))
...
#define TIM0_CR_STR_BIT                           (*(__IO uint32_t*)(0x42008000))
#define TIM0_CR_OPM_BIT                           (*(__IO uint32_t*)(0x4200800C))
#define TIM0_CR_IE_BIT                            (*(__IO uint32_t*)(0x42008018))
#define TIM0_CR_TRIGEN_BIT                        (*(__IO uint32_t*)(0x42008020))
#define TIM0_CR_ETEN_BIT                          (*(__IO uint32_t*)(0x42008024))
#define TIM0_CR_TC_BIT                            (*(__IO uint32_t*)(0x42008028))
#define TIM0_CR_CASCEN_BIT                        (*(__IO uint32_t*)(0x4200803C))
#define TIM0_TIMINTF_TF_BIT                       (*(__I  uint32_t*)(0x42008200))
#define TIM0_TIMINTF_TFC_BIT                      (*(__O  uint32_t*)(0x42008240))
#define TIM1_CR_STR_BIT                           (*(__IO uint32_t*)(0x42010000))
#define TIM1_CR_OPM_BIT                           (*(__IO uint32_t*)(0x4201000C))
#define TIM1_CR_IE_BIT                            (*(__IO uint32_t*)(0x42010018))
#define TIM1_CR_TRIGEN_BIT                        (*(__IO uint32_t*)(0x42010020))
#define TIM1_CR_ETEN_BIT                          (*(__IO uint32_t*)(0x42010024))
#define TIM1_CR_TC_BIT                            (*(__IO uint32_t*)(0x42010028))
#define TIM1_CR_CASCEN_BIT                        (*(__IO uint32_t*)(0x4201003C))
#define TIM1_TIMINTF_TF_BIT                       (*(__I  uint32_t*)(0x42010200))
#define TIM1_TIMINTF_TFC_BIT                      (*(__O  uint32_t*)(0x42010240))
#define TIM2_CR_STR_BIT                           (*(__IO uint32_t*)(0x42018000))
#define TIM2_CR_OPM_BIT                           (*(__IO uint32_t*)(0x4201800C))
#define TIM2_CR_IE_BIT                            (*(__IO uint32_t*)(0x42018018))
#define TIM2_CR_TRIGEN_BIT                        (*(__IO uint32_t*)(0x42018020))
#define TIM2_CR_ETEN_BIT                          (*(__IO uint32_t*)(0x42018024))
#define TIM2_CR_TC_BIT                            (*(__IO uint32_t*)(0x42018028))
#define TIM2_CR_CASCEN_BIT                        (*(__IO uint32_t*)(0x4201803C))
#define TIM2_TIMINTF_TF_BIT                       (*(__I  uint32_t*)(0x42018200))
#define TIM2_TIMINTF_TFC_BIT                      (*(__O  uint32_t*)(0x42018240))
#define TIM3_CR_STR_BIT                           (*(__IO uint32_t*)(0x42020000))
#define TIM3_CR_OPM_BIT                           (*(__IO uint32_t*)(0x4202000C))
#define TIM3_CR_IE_BIT                            (*(__IO uint32_t*)(0x42020018))
#define TIM3_CR_TRIGEN_BIT                        (*(__IO uint32_t*)(0x42020020))
#define TIM3_CR_ETEN_BIT                          (*(__IO uint32_t*)(0x42020024))
#define TIM3_CR_TC_BIT                            (*(__IO uint32_t*)(0x42020028))
#define TIM3_CR_CASCEN_BIT                        (*(__IO uint32_t*)(0x4202003C))
#define TIM3_TIMINTF_TF_BIT                       (*(__I  uint32_t*)(0x42020200))
#define TIM3_TIMINTF_TFC_BIT                      (*(__O  uint32_t*)(0x42020240))
...
#define ADC2_ADCON1_ADSOC_BIT                     (*(__IO uint32_t*)(0x42830000))
#define ADC2_ADCON1_MOD_BIT                       (*(__IO uint32_t*)(0x4283000C))
#define ADC2_ADCON1_ADDE_BIT                      (*(__IO uint32_t*)(0x42830018))
#define ADC2_ADCON1_ADIE_BIT                      (*(__IO uint32_t*)(0x4283001C))
#define ADC2_ADCON1_ADON_BIT                      (*(__IO uint32_t*)(0x4283003C))
#define ADC2_ADCMPCON_ADLDE_BIT                   (*(__IO uint32_t*)(0x42830590))
#define ADC2_ADCMPCON_ADLIE_BIT                   (*(__IO uint32_t*)(0x42830594))
#define ADC2_ADCMPCON_ADGDE_BIT                   (*(__IO uint32_t*)(0x42830598))
#define ADC2_ADCMPCON_ADGIE_BIT                   (*(__IO uint32_t*)(0x4283059C))
#define ADC2_ADINTF_ADLIF_BIT                     (*(__I  uint32_t*)(0x42830800))
#define ADC2_ADINTF_ADGIF_BIT                     (*(__I  uint32_t*)(0x42830804))
#define ADC2_ADINTF_ADIF_BIT                      (*(__I  uint32_t*)(0x42830808))
#define ADC2_ADINTF_ADLIFC_BIT                    (*(__O  uint32_t*)(0x42830840))
#define ADC2_ADINTF_ADGIFC_BIT                    (*(__O  uint32_t*)(0x42830844))
#define ADC2_ADINTF_ADIFC_BIT                     (*(__O  uint32_t*)(0x42830848))
