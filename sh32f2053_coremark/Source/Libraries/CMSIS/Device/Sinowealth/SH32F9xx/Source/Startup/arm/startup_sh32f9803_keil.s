...
__Vectors
                         ...
                         DCD      Default_Handler      ;  13 (074H) Reserved
                         DCD      Default_Handler      ;  14 (078H) Reserved
                         ...
                         DCD      ADC2_Handler         ;  19 (08CH) ADC2 Interrupt
                         ...
                         DCD      GPT3_GTCIV_Handler   ;  28 (0B0H) GPT3 GTCIV Interrupt
                         DCD      GPT3_GTCIN_Handler   ;  29 (0B4H) GPT3 GTCIN Interrupt
                         DCD      GPT_POE_Handler      ;  30 (0B8H) GPT POE Global Interrupt
                         DCD      EXTI9_5_Handler      ;  31 (0BCH) EXTI Line5 ~ Line9 global Interrupt
                         DCD      Default_Handler      ;  32 (0C0H) Reserved
                         DCD      Default_Handler      ;  33 (0C4H) Reserved
                         DCD      Default_Handler      ;  34 (0C8H) Reserved
                         DCD      Default_Handler      ;  35 (0CCH) Reserved
                         ...
                         DCD      SPI2_Handler         ;  39 (0DCH) SPI2 Interrupt
                         ...
                         DCD      TIM0_Handler         ;  49 (104H) TIM0 Interrupt
                         DCD      TIM1_Handler         ;  50 (108H) TIM1 Interrupt
                         DCD      TIM2_Handler         ;  51 (10CH) TIM2 Interrupt
                         DCD      TIM3_Handler         ;  52 (110H) TIM3 Interrupt
...
Default_Handler          PROC
                         ...
                         EXPORT   GPT3_GTCIV_Handler   [WEAK]
                         EXPORT   GPT3_GTCIN_Handler   [WEAK]
