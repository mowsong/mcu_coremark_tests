...
#ifndef __SH32F2xx_NVIC_H
#define __SH32F2xx_NVIC_H
...
typedef struct
{
    uint8_t NVIC_IRQChannel;                    /*!< Specifies the IRQ channel to be enabled or disabled.
                                                   ...
                                                   enumeration (please refer to sh32f2xx.h file) */
...
#define NVIC_PriorityGroup_0         ((uint32_t)0x300) /*!< 4 bits for pre-emption priority
                                                            0 bits for subpriority */
#define NVIC_PriorityGroup_1         ((uint32_t)0x400) /*!< 3 bits for pre-emption priority
                                                            1 bits for subpriority */
#define NVIC_PriorityGroup_2         ((uint32_t)0x500) /*!< 2 bits for pre-emption priority
                                                            2 bits for subpriority */
#define NVIC_PriorityGroup_3         ((uint32_t)0x600) /*!< 1 bits for pre-emption priority
                                                            3 bits for subpriority */
#define NVIC_PriorityGroup_4         ((uint32_t)0x700) /*!< 0 bits for pre-emption priority
